...
{
    /// <summary>
    /// Maps a configuration object to backoffice properties and back, through the mappings a descriptor defines.
    /// </summary>
    public abstract class BaseConfigDescriptor<TConfig> where TConfig : class, new()
    {
        private readonly List<DescriptorMapping<TConfig>> _mappings = [];
